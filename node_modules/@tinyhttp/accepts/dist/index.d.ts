import Negotiator from 'negotiator'; // Ensure the 'negotiator' package is installed
import { IncomingMessage as I, IncomingHttpHeaders } from 'http'; // Use 'http' directly

// ... (Rest of your Accepts class code remains the same)
